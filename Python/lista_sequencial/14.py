...
#para controlar o rendimento diário de seu trabalho. Toda vez que ele traz um peso de peixes maior que o estabelecido
...
peso_peixe=float(input("Informe o peso do seu peixe:"))
